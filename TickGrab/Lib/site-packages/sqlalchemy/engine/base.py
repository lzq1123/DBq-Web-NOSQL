...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def invalidate(self, exception: Optional[BaseException] = None) -> None:
        ...
        :class:`.Transactions` object is ended, by calling the
        :meth:`.Transactions.rollback` method; until that point, any attempt at
    ...
    def begin(self) -> RootTransaction:
        ...
        which completes when either the :meth:`_engine.Transactions.rollback`
        or :meth:`_engine.Transactions.commit` method is called; the object
        ...
        if self._transaction is None:
            ...
            raise exc.InvalidRequestError(
                ...
                "Transactions() object via begin() or autobegin; can't "
    ...
    def begin_nested(self) -> NestedTransaction:
        ...
        automatically. Like any other :class:`_engine.Transactions`, the
    ...
    def begin_twophase(self, xid: Optional[Any] = None) -> TwoPhaseTransaction:
        ...
        :class:`.Transactions`, also provides a
    ...
    def close(self) -> None:
        ...
        of any :class:`.Transactions` object that may be
...
class Transactions(TransactionalContext):
    """Represent a database transaction in progress.

    The :class:`.Transactions` object is procured by
    ...
    The Transactions object is **not** threadsafe.
    ...
    def close(self) -> None:
        """Close this :class:`.Transactions`.

        If this transaction is the base transaction in a begin/commit
        nesting, the transaction will rollback().  Otherwise, the
        method returns.

        This is used to cancel a Transactions without affecting the scope of
    ...
    def rollback(self) -> None:
        """Roll back this :class:`.Transactions`.
    ...
    def commit(self) -> None:
        """Commit this :class:`.Transactions`.
...
class RootTransaction(Transactions):
...
class NestedTransaction(Transactions):
...
class TwoPhaseTransaction(RootTransaction):
    ...
    The interface is the same as that of :class:`.Transactions`
...
class Engine(
    ...
    def begin(self) -> Iterator[Connection]:
        ...
        with a :class:`.Transactions` established.
        ...
        Upon successful operation, the :class:`.Transactions`
        is committed.  If an error is raised, the :class:`.Transactions`
        is rolled back.
        ...
        .. seealso::
            ...
            :meth:`_engine.Connection.begin` - start a :class:`.Transactions`
