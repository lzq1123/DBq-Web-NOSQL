...
from ...engine.base import Transactions
...
class AsyncConnection(
    ...
    def get_transaction(self) -> Optional[AsyncTransaction]:
        ...
        :class:`_engine.Transactions`, which is then proxied in a new
    ...
    def get_nested_transaction(self) -> Optional[AsyncTransaction]:
        ...
        current :class:`_engine.Transactions`, which is then proxied in a new
        :class:`.AsyncTransaction` object.
...
class AsyncTransaction(
    ProxyComparable[Transactions], StartableContext["AsyncTransaction"]
):
    """An asyncio proxy for a :class:`_engine.Transactions`."""

    __slots__ = ("connection", "sync_transaction", "nested")

    sync_transaction: Optional[Transactions]
    ...
    @util.ro_non_memoized_property
    def _proxied(self) -> Transactions:
